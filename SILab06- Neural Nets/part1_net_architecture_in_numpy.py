...
def zad2_two_layer_net(student_id):
    ...
    class SimpleTwoLayerNetwork:
        def __init__(self, n_in, n_hidden, n_out):
            ...
            self.output_layer = DenseLayer(n_in, n_out, f_act=hardlim)
    ...
    model.hidden_layer.W[:, 1] = [0.5, -0.5]      # wagi neuronu h2 x=nachylenie y= pozycja
    model.hidden_layer.b[:] = [0.05, -0.3]         # biasy neuronów h1 i h2
    model.output_layer.W[:, 0] = [0.35, -0.35]      # wagi neuronu wyjściowego
    model.output_layer.b[:] = -0.12  # bias neuronu wyjściowego
...
if __name__ == '__main__':
    ...
    student_id = 192594  # Twój numer indeksu, np. 102247
